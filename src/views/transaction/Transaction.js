                                    ...
                                    <tbody>
                                        <tr className="unread">
                                            ...
                                            <td>
                                                ...
                                                <p className="m-0"> $3.2 - FPT Uni Cabinet - Box 06 </p>
                                            </td>
                                            <td>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15" />11 MAY 12:50</h6>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-red f-10 m-r-15" />12 MAY 16:50</h6>
                                            </td>
                                        ...
                                        <tr className="unread">
                                            ...
                                            <td>
                                                ...
                                                <p className="m-0"> 2.7$ - Vincom Thu Duc  Cabinet - Box 12 </p>
                                            </td>
                                            <td>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15" />11 MAY 12:50</h6>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-red f-10 m-r-15" />12 MAY 16:50</h6>                                        </td>
                                            <td><a href={DEMO.BLANK_LINK} className="label theme-bg2 text-white f-12">Delete</a><a href={DEMO.BLANK_LINK} className="label theme-bg text-white f-12">Details</a></td>
                                        </tr>
                                        <tr className="unread">
                                            ...
                                            <td>
                                                ...
                                                <p className="m-0">4.5$ - Vincom Thu Duc  Cabinet - Box 09</p>
                                            </td>
                                            <td>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15" />11 MAY 12:50</h6>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-red f-10 m-r-15" />12 MAY 16:50</h6>                                        </td>
                                        ...
                                        <tr className="unread">
                                            ...
                                            <td>
                                                ...
                                                <p className="m-0">3.1$ - Hutech Uni Cabinet - Box 05</p>
                                            </td>
                                            <td>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15" />11 MAY 12:50</h6>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-red f-10 m-r-15" />12 MAY 16:50</h6>                                        </td>
                                        ...
                                        <tr className="unread">
                                            ...
                                            <td>
                                                ...
                                                <p className="m-0">2.9$ - Passio FPT CoffeeCabinet - Box 12</p>
                                            </td>
                                            <td>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15" />11 MAY 12:50</h6>
                                                <h6 className="text-muted"><i className="fa fa-circle text-c-red f-10 m-r-15" />12 MAY 16:50</h6>                                        </td>
