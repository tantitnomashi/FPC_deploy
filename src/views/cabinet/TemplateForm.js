...
export default function TemplateForm(props) {
    ...
    return (
        <div>
            ...
            <Dialog maxWidth={'lg'}
                className="dialog-userForm" open={open} onClose={handleClickClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title">{currentProfile ? "Update" : "Create Template"}</DialogTitle>
                <DialogContent  >
                    ...
                    <Form >
                        <Form.Row>
                            ...
                            <Col md={6} xl={6}>
                                <div>
                                    <Image size='lg' src={demoType[type].url} fluid />
                                </div>
                                <div>
